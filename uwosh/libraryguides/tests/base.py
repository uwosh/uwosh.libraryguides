...
def setup_product():
    ...
    import uwosh.libraryguides
    zcml.load_config('configure.zcml', uwosh.libraryguides)
    ...
    ztc.installPackage('uwosh.libraryguides')
...
setup_product()
ptc.setupPloneSite(products=['uwosh.libraryguides','uwosh.librarycache'])
